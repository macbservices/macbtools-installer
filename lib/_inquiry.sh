...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador MacbTools, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar MacbTools\n"
  printf "   [1] Atualizar MacbTools\n"
  printf "   [2] Deletar MacbTools\n"
  printf "   [3] Bloquear MacbTools\n"
